...
\beqn
\thetahatmmse = \frac{\alpha + X}{\alpha + \beta + n} = \frac{\alpha}{\alpha + \beta + n} + \frac{n}{\alpha + \beta + n} \Xbar \approxdist \normnot{\frac{\alpha}{\alpha + \beta + n} + \theta}{\frac{n\theta (1 - \theta)}{(\alpha + \beta + n)^2}}
\eeqn
}
...
&=& \frac{\alpha - 1}{\alpha + \beta + n - 2} + \parens{\frac{n}{\alpha + \beta + n - 2} - 1} \theta\\
&=& \frac{\alpha - 1 + \parens{\alpha + \beta - 2} \theta}{\alpha + \beta + n - 2}\\
\eeqn
}
...
\inred{
\beqn
f(\theta\,|\,\X) &=& \gammanot{1 + \sum x_i}{n} = \gammanot{5754}{10} \\
...
p_{val} &:=& \cprob{H_0}{X} = \cprob{\theta \geq 4}{X} = 1 - \text{pt.scaled}(26, 4.289, 0.0195) 
\eeqn}
