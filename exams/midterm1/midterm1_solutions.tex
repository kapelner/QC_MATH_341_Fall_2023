...
\color{black}
\subquestionwithpoints{2} If $n$ was very, very large, would this test have been rejected given the same point estimate? Yes / \inblue{\underline{no}} \spc{-0.5}
...
\beqn
\doublehat{z} = (19.3 - 19) / 1.38 = 0.22~\Rightarrow p_{val} \approx \prob{Z > \doublehat{z}} = 1 - \prob{Z < -\doublehat{z}} = \Phi(-0.22) \approx 0.59
\eeqn
...
\beqn
CI_{\theta, 95\%} = \bracks{\xbar \pm z_{97.5\%} \times \se{\Xbar}} \approx \bracks{19.3 \pm 2 \times \frac{\sqrt{8.61}}{\sqrt{10}}} = \bracks{17.44, 21.16}
\eeqn
